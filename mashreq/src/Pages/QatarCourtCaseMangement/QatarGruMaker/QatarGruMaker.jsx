...
import QGruMakerDetails from './QGruMakerDetails';
...
export default function QatarGruMaker() {
  ...
  const tabs = [
    {
      label: "Gru Maker",
      Component:<QGruMakerDetails AccountsTable={AccountsTable} CommentsTable={CommentsTable} expanded={expanded} handleChangeAccordian={handleChangeAccordian}></QGruMakerDetails>
  ...
  return (
    ...
    <DynamicHead/>
<Box>
<Typography variant='h6' color="primary" >Qatar Gru Maker</Typography>
</Box>
