...
export default function QatarChecker() {
  ...
  const tabs = [
    {
      label: "Qatar Checker",
      Component:<CamCpuChekerDetails isChecker={true} AccountsTable={AccountsTable} CommentsTable={CommentsTable} expanded={expanded} handleChangeAccordian={handleChangeAccordian}></CamCpuChekerDetails>
...
<Box>
<Typography variant='h6' color="primary" >Qatar Checker</Typography>
</Box>
    
<CustomTabs TotalTab={tabs} value={value} onChange={handleChange} maxWidth={"107px"} />
